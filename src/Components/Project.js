    ...
    <div>
        <Carousel className='carousel'>
            <CarouselItem className='carousel'>
                <div className='services' style={{backgroundImage: 'url(/img/Web-Development.jpeg', backgroundRepeat: 'no-repeat', backgroundSize:'center', height:'70vh', width:'100%', alignContent: 'center' }}>
